...
import com.github.dmtest.tender.dto.rq.tenders.contents.AddTenderContentsRqDto;
...
import com.github.dmtest.tender.repo.TenderContentsRepo;
...
public class TenderContentsController {
    ...
    public OperationResultRsDto addTenderContents(@RequestBody AddTenderContentsRqDto addTenderContentsRqDto) {
        ...
        tenderContents.forEach(content -> {
            ...
            TenderContent tenderContent = new TenderContent(tender, product, content.getQuantity(), content.getCostPerUnit());
